package com.shiyi.remoting.transport.netty.codec;

import com.shiyi.compress.Compress;
...
/**
 * <p>
 * custom protocol: header fixed take up 16B
 * <p>
 * <pre>
...
public class RpcMessageDecoder extends LengthFieldBasedFrameDecoder {
    ...
    public RpcMessageDecoder() {
        ...
        // lengthAdjustment: full length include header and data, so the left length is (fullLength-9). so the value is -9(refer:Last example of official notes).
